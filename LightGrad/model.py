...
from .utils import (sequence_mask, generate_path, duration_loss,
                    fix_len_compatibility)


class LightGrad(BaseModule):
    ...
    def forward_streaming(self,
        ...
        (num_chunks, chunk_lengths, start_frames, end_frames, lpad,
         rpad) = generate_idxs(w_ceil, out_size)
...
def generate_idxs(durations, chunk_frames):
    """
